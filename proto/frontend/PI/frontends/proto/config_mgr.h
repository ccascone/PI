...
#ifndef PI_FRONTENDS_PROTO_CONFIG_MGR_H_
#define PI_FRONTENDS_PROTO_CONFIG_MGR_H_
...
class GnmiConfigMgr {
 ...
 private:
  // PIMPL design
  std::unique_ptr<GnmiConfigMgrImp> pimp;
};
...
#endif  // PI_FRONTENDS_PROTO_CONFIG_MGR_H_
